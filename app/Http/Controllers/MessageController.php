...
class MessageController extends Controller
{
    ...
    // public function __construct(ThucDonController $thucDonController)
    //     {
    ...
    private function tuVanKhauPhanAn($messagex)
    {
        ...
        return Redirect::to("thucdon/$sex/$month/$weight/$height");
    }
