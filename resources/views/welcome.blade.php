    ...
    <header class="msger-header">
      ...
      <div class="msger-header-options">
        <form action="{{URL::to('/delete')}}" method="post">
          {{ csrf_field() }}
          <button class="btn-delete" style="border: none;background-color: #579ffb; padding: 5px 5px 5px 5px;color:white;border-radius:4px;">Tạo cuộc trò chuyện mới</button>
        </form>
      </div>
    </header>
